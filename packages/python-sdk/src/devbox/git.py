...
class Git:
    """Common Git operations executed inside a sandbox."""
    ...
    def status(self, repository: str) -> CommandResult:
        """Return the short status of a sandbox repository."""
    ...
    def checkout(self, repository: str, reference: str, *, create: bool = False) -> CommandResult:
        """Check out a branch or reference, optionally creating it."""
        arguments = ["checkout"]
        if create:
            arguments.append("-b")
...
class AsyncGit:
    """Asynchronous counterpart of :class:`Git`."""
